...
(function($, window, document) {
		...
		*/
		function flickityInit() {
			...
			$('.nectar-flickity:not(.masonry)').each(function (i) {
				...
				if ( $(this).closest('.full-width-content').hasClass('flickity-left') ) {
					$flickCellAlign   = 'left';
				}
				...
				*/
				function fullWidthSections() {
					...
					$('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), .full-width-content').each(function () {
						...
						// $carouselWidth = $carouselWidth - 60;
						...
						!$(this).find('.portfolio-items:not(".carousel")[data-col-num="elastic"]').length > 0) {
							...
							$(this).parents('.full-width-tabs').length == 0) {
								...
								if ($(this).hasClass('portfolio-items')) {
									...
									$(this).css({
										'margin-left': -$justOutOfSight+30,
										'left': 0,
										'width': $carouselWidth-60,
										'visibility': 'visible'
									});
			...
			function nectarPostGridInit() {
				...
				*/
				function calculateHoverNavMinHeight() {
					...
					console.log("calculateHoverNavMinHeight");
				...
				*/
				function OCM_slideOutRightHoverOpen() {
					...
					if ($('#header-outer[data-permanent-transparent="1"]').length == 0 && 
						...
						nectarDOMInfo.winW > 1000) {
						console.log("OCM_slideOutRightHoverOpen");
				...
				*/
				function OCM_slideOutRightHoverCloseCheck(e) {
					...
					if (e.clientX < $windowWidth - 800 - $bodyBorderWidth && $offCanvasEl.hasClass('mouse-accessed')) {
				...
				*/
				function OCM_init() {
					...
					if ($('#slide-out-widget-area.slide-out-from-right-hover').length > 0) {
						console.log("OCM_slideOutRightHoverInit");
	...
	$('html').click(function (event) {
		if ($(event.target).closest('#slide-out-widget-area, .admin-bar .slide-out-hover-icon-effect:not(.small), .slide-out-widget-area-toggle').length === 0) {
			OCM_mobileSlideOutRightHoverCloseCheck();
		}
	});
...
jQuery(document).ready(function($) {
	$('.ui-tabs-nav-select').select2({minimumResultsForSearch: -1});
	$('.ui-tabs-nav-select').bind('change', function(event) {
		var $id = $(this).val();
		var $frontEndEditorTabDiv = ($('body.vc_editor').length > 0) ? '> .wpb_tab ' : '';
		...
		$(this).parents('.tabbed').find('> div:nth-of-type(' + $id + ')' + $frontEndEditorTabDiv).css({
			'visibility': 'visible',
			'position': 'relative',
			'left': '0',
			'display': 'block'
